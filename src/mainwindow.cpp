...
void MainWindow::initialize() {
    ...
    tesselation_label->setText("Cube Parameters");
    ...
    ec_label->setText("Additional Parameters");
    ec_label->setFont(font);
    QLabel *param1_label = new QLabel(); // Parameter 1 label
    param1_label->setText("Number of Layers:");
    QLabel *param2_label = new QLabel(); // Parameter 2 label
    param2_label->setText("Size of Base:");
    ...
    // Extra Credit:
    ec1 = new QCheckBox();
    ec1->setText(QStringLiteral("Fixed Base Size"));
    ec1->setChecked(false);

    ec2 = new QCheckBox();
    ec2->setText(QStringLiteral("Noise"));
    ec2->setChecked(false);

    ec3 = new QCheckBox();
    ec3->setText(QStringLiteral("Rotate"));
    ec3->setChecked(false);

    ec4 = new QCheckBox();
    ec4->setText(QStringLiteral("Terrain"));
